package luis122448.SmartShell.application.domain.web.constant;
...
public class APIConstants {
	...
	public final static String TAG_BUSINESS_PARTNER="Business Partner";
	public final static String PATH_ARTICLE_INVENTORY="/article-inventory";
	public final static String TAG_ARTICLE_INVENTORY="Article and Inventory";
